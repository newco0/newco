 ...
 */
final class Version20200405172257 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE discussion CHANGE date_update date_update DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE date_delete date_delete DATETIME NOT NULL');
