 ...
 */
final class Version20200329101032 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact CHANGE is_active is_active TINYINT(1) NOT NULL, CHANGE is_read is_read TINYINT(1) NOT NULL');
